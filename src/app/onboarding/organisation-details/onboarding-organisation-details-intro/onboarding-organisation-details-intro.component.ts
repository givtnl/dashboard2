...
@Component({
    ...
    styleUrls: ['../../onboarding.scss', './onboarding-organisation-details-intro.component.scss']
})
export class OnboardingOrganisationDetailsIntroComponent implements OnInit {
    ...
    continue() {
        ...
        || DirectDebitTypeHelper.fromOrganisationDetailModel(this.service.currentOrganisationRegistrationDetailsModel) == DirectDebitType.SEPA)
